    ...
    return (
            <div className="head w-full h-[7vh]">
                <div className='grid grid-flow-col bg-white border-gray-700 fixed w-full px-2 py-2 z-10'>
                    <div className='flex'>
                        <div className='h-5 ml-4 mt-2'><HamburgerIcon /></div>
                        <div className='h-5 ml-6 mt-2'><YouTubeIcon /></div>
                    </div>
                    <div>
                        <input type='text' placeholder='Search' className='w-10/12 h-2 mt-0 border-2 border-gray-100 rounded-l-full p-4' />
                    ...
                    <div className='flex justify-end'>
                        <div className='h-8 p-1 border-2 mr-10 border-black rounded-full'>
